-- -----------------------------------------------------
-- DB v1.0 generated by Mahmoud Saada on MYSQL Workbench
-- -----------------------------------------------------
...
CREATE  TABLE IF NOT EXISTS `mds_db`.`T_GroupPermit` (
  ...
  `GP_permission` CHAR(2) NOT NULL ,
  `GP_idpath` TEXT NOT NULL ,
...
CREATE  TABLE IF NOT EXISTS `mds_db`.`T_UserPermit` (
  ...
  `E_id` INT(11) NULL DEFAULT NULL ,
  `UP_permission` CHAR(2) NOT NULL ,
  `UP_idpath` TEXT NOT NULL ,
